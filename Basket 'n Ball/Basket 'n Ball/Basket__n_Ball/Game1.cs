...
namespace Basket__n_Ball
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Random rndmAngle1, rndmPow1, rndmAngle2, rndmPow2;    // Random number for splash screen
        int splash;
        ...
        protected override void Initialize()
        {
            ...
            rndmAngle1 = new Random();
            rndmPow1 = new Random();
            rndmAngle2 = new Random();
            rndmPow2 = new Random();
            basketRandom1 = true;
            base.Initialize();
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (gameState == "splash")
            {
                if (splash == 1)
                {
                    angleR1 = rndmAngle1.Next(0, 90);
                    powR1 = rndmPow2.Next(50, 200);
                }
                else if (splash == 2)
                {
                    angleR2 = rndmAngle2.Next(0, 90);
                    powR2 = rndmPow2.Next(50, 200);
                }
            }
